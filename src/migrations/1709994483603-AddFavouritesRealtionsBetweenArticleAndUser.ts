...
export class AddFavouritesRealtionsBetweenArticleAndUser1709994483603 implements MigrationInterface {
    name = 'AddFavouritesRealtionsBetweenArticleAndUser1709994483603'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users_favourites_articles" ("usersId" uuid NOT NULL, "articlesId" uuid NOT NULL, CONSTRAINT "PK_15142a371ce15e21a3748836328" PRIMARY KEY ("usersId", "articlesId"))`);
